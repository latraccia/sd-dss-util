 ...
 *
 * @deprecated Use {@link SignatureCLIModel} instead
 *
 * Date: 28/11/13
 * Time: 11.07
 *
 *
 * @see it.latraccia.dss.cli.main.model.SignatureModel
 *
 * @author Francesco Pontillo
 */
public class SignatureCLIModelDeprecated extends SignatureModel {
    ...
    public SignatureCLIModelDeprecated() {
        super();
    }

    public SignatureCLIModelDeprecated(String serviceUrl) {
        super();
