...
import it.latraccia.dss.cli.main.builder.format.CAdESFormatBuilder;
import it.latraccia.dss.cli.main.builder.format.FormatBuilder;
import it.latraccia.dss.cli.main.builder.format.XAdESFormatBuilder;
import it.latraccia.dss.cli.main.builder.policy.PolicyBuilder;
import it.latraccia.dss.cli.main.builder.token.MoccaTokenBuilder;
import it.latraccia.dss.cli.main.builder.token.PKCS11TokenBuilder;
import it.latraccia.dss.cli.main.builder.token.PKCS12TokenBuilder;
import it.latraccia.dss.cli.main.builder.token.TokenBuilder;
import it.latraccia.dss.cli.main.entity.DigestAlgorithm;
...
public class SignatureBuilder implements IBuilder<File> {
    ...
    private SignatureBuilder setFormatBuilder(FormatBuilder formatBuilder) {
     ...
     * This method is a wrapper around the original {@link it.latraccia.dss.cli.main.builder.SignatureBuilder#prepareTargetFileName(java.io.File, eu.europa.ec.markt.dss.signature.SignaturePackaging, String)}.
     *
    ...
    private String getSuggestedFileName() {
        return prepareTargetFileName(
                ...
                signatureFormatLevelPackaging.getLevel().getValue()).getName();
    }
    ...
    public class InputDSSPrivateKeyChooser implements IDSSPrivateKeyChooser {
        @Override
        public DSSPrivateKeyEntry getDSSPrivateKey(List<DSSPrivateKeyEntry> keys) {
    ...
    protected class InnerSignatureBuilder {
         ...
         *
         * @param model         The signature model
         * @throws it.latraccia.dss.cli.main.exception.SignatureException Thrown if there is some kind of signature parameter mismatch
         */
        ...
        protected void validateSignaturePackagingFileTypeMatch(SignatureCLIModel model) throws SignaturePackagingMismatchException {
            ...
            if (signatureFormat.equals(it.latraccia.dss.cli.main.entity.format.SignatureFormat.XAdES)
        ...
        protected void validateServiceUrl(SignatureCLIModel model) throws SignatureServiceUrlException {
            ...
            if (Util.isNullOrEmpty(serviceUrl)) {
                ...
                if (model.getFormat().startsWith(it.latraccia.dss.cli.main.entity.format.SignatureFormat.PAdES.getValue())
        ...
        protected void setToken(TokenBuilder tokenBuilder, SignatureCLIModel model) throws SignatureMoccaAlgorithmMismatchException, SignatureMoccaUnavailabilityException, FileNotFoundException {
            ...
            if (token.getTokenType().equals(it.latraccia.dss.cli.main.entity.token.SignatureTokenType.MOCCA)) {
         ...
         *
         * @param policyBuilder The {@link it.latraccia.dss.cli.main.builder.policy.PolicyBuilder} that will be built to get the set values
         * @param model         The signature model
